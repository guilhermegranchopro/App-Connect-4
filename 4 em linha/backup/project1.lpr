...
var
  ...
  begin
    ...
    begin
      ...
      begin
        if ((board[fictionalX - counter, fictionalY] = 0) and (fictionalPiece = 1)) then
        begin
          counterForTheWin := counterForTheWin + 1;
          fictionalPiece := 0;
  ...
  begin
    ...
    begin
      ...
      begin
        if ((board[fictionalX, fictionalY - counter] = 0) and (fictionalPiece = 1)) then
        begin
          counterForTheWin := counterForTheWin + 1;
          fictionalPiece := 0;
